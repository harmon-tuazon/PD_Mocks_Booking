      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="grid grid-cols-7 gap-1 mb-4">
            {weekDays.map(day => (
              <div key={day} className="text-center text-sm font-subheading font-medium text-gray-600 py-2">
                {day}
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-cool-grey">
            <div className="flex items-center justify-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 font-body">Available sessions</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 font-body">No sessions</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {selectedSessions.map((session) => (
                  <div
                    ...
                    className={`p-3 border-2 border-cool-grey rounded-lg ${session.available_slots > 0 ? 'hover:shadow-md cursor-pointer hover:border-primary-300 bg-white' : 'opacity-75 bg-gray-50'} transition-all duration-200`}
                    onClick={() => handleSessionSelect(session)}
                  >
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-xs font-subheading font-semibold text-navy-800">
