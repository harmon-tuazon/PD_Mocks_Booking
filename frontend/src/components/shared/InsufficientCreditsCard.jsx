...
const InsufficientCreditsCard = ({ mockType = 'mock exam', onContactSupport, className = '' }) => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-coral-50 via-white to-coral-50 ${className}`}>
      <div className="container-brand-sm py-12">
        ...
        <div className="card-brand text-center animate-fade-in">
          {/* Warning Icon */}
          <div className="mb-6">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-coral-100 rounded-full">
              <svg className="w-10 h-10 text-coral-600" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          ...
          <div className="bg-coral-50 rounded-lg p-6 mb-8 border border-coral-200">
            <h2 className="font-subheading text-lg font-semibold text-coral-800 mb-4">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-white hover:bg-coral-50 border border-coral-200 hover:border-coral-300 rounded-lg p-4 transition-all duration-200 group focus-coral"
                aria-label="Send email to PrepDoctors support"
              >
                <div className="flex items-center justify-center space-x-3">
                  <div className="flex-shrink-0">
                    <svg className="w-5 h-5 text-coral-600 group-hover:text-coral-700" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                      <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                      <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-subheading font-medium text-coral-800 group-hover:text-coral-900">
                      Email Support
                    </p>
                    <p className="font-body text-sm text-coral-600 group-hover:text-coral-700">
          ...
          <div className="mb-6">
            <button
              ...
              className="btn-brand-secondary w-full btn-large inline-flex items-center justify-center"
          ...
          <div className="pt-6 border-t border-coral-200">
            <div className="bg-primary-50 rounded-lg p-4 border border-primary-200">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  <h3 className="font-subheading font-semibold text-primary-800 text-sm mb-1">
...
export default InsufficientCreditsCard;