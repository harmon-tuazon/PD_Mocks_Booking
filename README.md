...
The PRD (Project Requirements Documentation) framework is a simple 3-step strategy for context engineering:
...
# 3. Execute the PRD to implement your feature
/execute-prd PRDs/your-feature-name.md
```
...
**No Vibe Coding**: Validate PRDs before executing them and the code after execution!

The more specific examples you provide, the better Claude can match your existing patterns and style.

*Note: Context engineering works with any AI coding assistant - the PRD framework and example-driven approach are universal principles.*
...
| `/execute-prd PRDs/feature.md` | Implement from blueprint |
